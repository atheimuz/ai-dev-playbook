...
export function Footer() {
    return (
        <footer className="border-t border-graphite-100 bg-graphite-50 dark:border-graphite-800 dark:bg-graphite-950">
            <div className="mx-auto max-w-7xl px-4 py-8">
                ...
                <div className="mt-6 text-center text-xs text-graphite-400 dark:text-graphite-500">
                    &copy; {new Date().getFullYear()} AI Dev Playbook. All rights reserved.
                </div>
            </div>
        </footer>
    );
